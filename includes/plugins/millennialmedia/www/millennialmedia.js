...
mmediaExport.setOptions = function(options, successCallback, failureCallback) {
	  if(typeof options === 'object') {
		  cordova.exec( successCallback, failureCallback, 'GelatoPluginMillennialMedia', 'setOptions', [options] );
	  } else {
...
mmediaExport.createBanner = function(args, successCallback, failureCallback) {
	...
	cordova.exec( successCallback, failureCallback, 'GelatoPluginMillennialMedia', 'createBanner', [ options ] );
};

mmediaExport.removeBanner = function(successCallback, failureCallback) {
	cordova.exec( successCallback, failureCallback, 'GelatoPluginMillennialMedia', 'removeBanner', [] );
};

mmediaExport.hideBanner = function(successCallback, failureCallback) {
	cordova.exec( successCallback, failureCallback, 'GelatoPluginMillennialMedia', 'hideBanner', [] );
};

mmediaExport.showBanner = function(position, successCallback, failureCallback) {
	if(typeof position === 'undefined') position = 0;
	cordova.exec( successCallback, failureCallback, 'GelatoPluginMillennialMedia', 'showBanner', [ position ] );
};

mmediaExport.showBannerAtXY = function(x, y, successCallback, failureCallback) {
	if(typeof x === 'undefined') x = 0;
	if(typeof y === 'undefined') y = 0;
	cordova.exec( successCallback, failureCallback, 'GelatoPluginMillennialMedia', 'showBannerAtXY', [{x:x, y:y}] );
};
...
mmediaExport.prepareInterstitial = function(args, successCallback, failureCallback) {
	...
	cordova.exec( successCallback, failureCallback, 'GelatoPluginMillennialMedia', 'prepareInterstitial', [ args ] );
};

mmediaExport.showInterstitial = function(successCallback, failureCallback) {
	cordova.exec( successCallback, failureCallback, 'GelatoPluginMillennialMedia', 'showInterstitial', [] );
};
